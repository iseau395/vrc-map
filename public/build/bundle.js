...
var app = (function () {
    ...
    const file$5 = "src\\components\\settings\\Switch.svelte";
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			span1 = element("span");
    			add_location(span0, file$5, 7, 0, 118);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "class", "svelte-1j727hj");
    			add_location(input, file$5, 9, 4, 170);
    			attr_dev(span1, "class", "slider svelte-1j727hj");
    			add_location(span1, file$5, 10, 4, 231);
    			attr_dev(label_1, "class", "switch svelte-1j727hj");
    			add_location(label_1, file$5, 8, 0, 142);
    		},
    ...
    class Switch extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, { label: 0, click: 2 });
    ...
    const file$4 = "src\\components\\settings\\SettingsPanel.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$4, 33, 4, 948);
    			attr_dev(input, "class", "settings-button svelte-t0nrcw");
    			attr_dev(input, "type", "checkbox");
    			add_location(input, file$4, 38, 4, 1064);
    			add_location(br0, file$4, 41, 8, 1245);
    			add_location(br1, file$4, 41, 14, 1251);
    			attr_dev(div0, "class", "settings-wrapper svelte-t0nrcw");
    			add_location(div0, file$4, 39, 4, 1119);
    			attr_dev(div1, "class", "settings-panel svelte-t0nrcw");
    			add_location(div1, file$4, 32, 0, 914);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { label: 0, onclick: 1 });
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(canvas_1, file$2, 294, 0, 12884);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let $imperial;
    	let $gameobjects;
    	validate_store(slot, 'slot');
    	component_subscribe($$self, slot, $$value => $$invalidate(2, $slot = $$value));
    	validate_store(points, 'points');
    	component_subscribe($$self, points, $$value => $$invalidate(3, $points = $$value));
    	validate_store(imperial, 'imperial');
    	component_subscribe($$self, imperial, $$value => $$invalidate(4, $imperial = $$value));
    	validate_store(gameobjects, 'gameobjects');
    	component_subscribe($$self, gameobjects, $$value => $$invalidate(5, $gameobjects = $$value));
     ...
     */
...

    		{
    			document.getElementById("slot-selector").addEventListener("input", event => {
    				...
    				set_store_value(slot, $slot = event.target.value, $slot);
    				load($slot);
    			});
    ...
    /* src\components\TextBox.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 3, 0, 50);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	return [value, input_handler, input_input_handler];
    }
    ...
    function create_fragment(ctx) {
    	...
    	button1 = new Button({
    			props: {
    				...
    				onclick: /*deleteAllSaves*/ ctx[2]
    			},
    			$$inline: true
    		});

    	function textbox_value_binding(value) {
    		/*textbox_value_binding*/ ctx[3](value);
    	}

    	let textbox_props = {};

    	if (/*$slot*/ ctx[0] !== void 0) {
    		textbox_props.value = /*$slot*/ ctx[0];
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 26, 0, 970);
    			add_location(form, file, 29, 8, 1023);
    			attr_dev(p, "id", "slots-list");
    			add_location(p, file, 34, 8, 1247);
    			add_location(div1, file, 28, 4, 1008);
    			attr_dev(div2, "class", "map-panel");
    			add_location(div2, file, 27, 0, 979);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (!updating_value && dirty & /*$slot*/ 1) {
    				updating_value = true;
    				textbox_changes.value = /*$slot*/ ctx[0];
    ...
    function instance($$self, $$props, $$invalidate) {
    	let $slot;
    	validate_store(slot, 'slot');
    	component_subscribe($$self, slot, $$value => $$invalidate(0, $slot = $$value));
    	let { $$slots: slots$1 = {}, $$scope } = $$props;
    	...
    	function deleteSave() {
    		...
    		if (slots) localStorage.setItem("all-slots-list", slots.filter(v => v != $slot).join("|")); else localStorage.setItem("all-slots-list", $slot);
    		load($slot);
    	}
    	...
    	function deleteAllSaves() {
    		...
    		set_store_value(slot, $slot = "slot1", $slot);
    	...
    	return [$slot, deleteSave, deleteAllSaves, textbox_value_binding];
    }
